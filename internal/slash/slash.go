...
func Builtins() []Command {
	return []Command{
		...
		{Name: "changelog", Description: "show the changelog"},
		...
		{Name: "trust", Description: "trust this project and write trust.json (restart to load resources)"},
		...
		{Name: "llama", Description: "list, load, unload, or download llama.cpp router models"},
